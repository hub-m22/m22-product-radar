...
TYPE_NAMES = {
    ...
    "rental": "Арендная компания", "tender_supplier": "Участник госзакупок (встречался с M22 в тендерах)", "events_supplier": "Поставщик оборудования для мероприятий", "marketplace_seller": "Маркетплейс-продавец", "foreign": "Зарубежная компания",
